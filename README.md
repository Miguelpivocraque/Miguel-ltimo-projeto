...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar da Miguel" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Miguel</p>
        <h1>Eu ensino Programação</h1>
        <p>Sou estudante de Computação e tecnologia . Ensino pensamento computacional para estudantes do Ensino
            Fundamental. Ensino sobre pensamento computacional usando HTML, CSS e JavaScript. Veja os projetos
            que já desenvolvi!</p>
